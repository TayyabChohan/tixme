...
const Home = () => {
  ...
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 768, // Adjust the breakpoint as needed for tablets
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
        },
      ...
      {
        breakpoint: 480, // Adjust the breakpoint as needed for mobile
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
        },
  ...
  return (
    <>
      ...
      <div className="mx-lg-4 my-lg-3 banner bg-primary-color rounded-8 position-relative">
        ...
        <h3 className="banner-h2 text-white rounded-8 px-4 py-3">
          Your Passport to Eventful Experiences
        </h3>
        <h3 className="banner-h2 text-white rounded-8 px-4 py-3">
          <h3 className="banner-h2 text-white rounded-8 px-4 py-3">
            <TextLoop interval={2000}>
              <span>Your Passport to Eventful Experiences</span>
        ...
        <div className="banner-child bg-white">
          <h5 className="text-primary-color fw-bold space-sec pt-4">
            Find Near By Events
          </h5>
                ...
                <SwiperSlide>
                  <div className="text-center position-relative">
                    <div className="event-card pt-4">
                      ...
                      <small className="d-block text-card-color my-2 mt-3">
                        {" "}
                        Music{" "}
                      </small>
                    </div>
      ...
      <div className="event-sec mx-4">
        <div className="d-flex align-items-start justify-content-start">
          ...
          <div className="d-flex align-items-center justify-content-start ms-2 border-bttom-dotted">
            ...
            <h5 className="text-primary-color fw-bold pt-4 me-4 mb-1">
              Boston
            </h5>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-4 text-center pt-4 pb-md-5 pb-0">
            <div className="border-end bottom-line border-primary pb-md-0 pb-4">
              <h6 className="fw-bold text-primary-color mb-0">EVENT HOSTED</h6>

              <p className="mb-0 fs-3 text-primary-color fw-bold">
          ...
          <div className="col-md-4 text-center pt-4 pb-md-5 pb-0">
            <div className="border-end bottom-line border-primary pb-md-0 pb-4">
              <h6 className="fw-bold text-primary-color mb-0">Ticket Sold</h6>
              <p className="mb-0 fs-3 text-primary-color fw-bold">
                {" "}
                <CountUp separator="" start={4000} end={6067} />+
              </p>
      ...
      <div className="partner-sec">
        <h3 className="fw-bold text-primary-color mb-0 text-center mb-0">
          OUR PARTNER
        </h3>
        <div className="carousel-container">
          <Slider {...settings}>
            {/* Add your images here */}
            <div className="partner-img partner-img custom-width">
              <img
            ...
            <div className="partner-img partner-img custom-width slick-slide slick-active slick-center slick-current">
            ...
            <div className="partner-img tui partner-img custom-width">
              <img
      ...
      <div className="newsletter-sec pb-4 position-relative">
        <div className="position-absolute md-absolute news-form">
          <h5 className="fw-bold text-primary-color mb-0 pt-2">
